...
export const Route = createFileRoute("/tools/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Explore 28+ premium PDF tools: convert, merge, split, edit, OCR, AI summarize and more." },
        ...
        <section className="border-b border-border/60 bg-card/40 py-14">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl">
              <p className="text-sm font-semibold text-accent uppercase tracking-wider">All tools</p>
              ...
              <p className="mt-4 text-muted-foreground">
                {tools.length} thoughtfully designed tools, organized by what you want to accomplish.
              </p>
            </motion.div>
