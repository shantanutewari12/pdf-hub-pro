...
export const tools: Tool[] = [
  ...
  },
  {
    slug: "word-to-pdf",
    name: "Word to PDF",
    description: "Turn Word files into polished PDFs.",
    icon: FileText,
    category: "convert",
    popular: true,
  },
  ...
  },
  {
    slug: "ppt-to-pdf",
    name: "PPT to PDF",
    description: "Export presentations as PDFs.",
    icon: Presentation,
    category: "convert",
  },
  {
    slug: "pdf-to-image",
    name: "PDF to Image",
    description: "Render PDF pages as JPG or PNG.",
    icon: FileImage,
    category: "convert",
  },
  {
    slug: "excel-to-pdf",
    name: "Excel to PDF",
    description: "Convert spreadsheets to clean PDFs.",
  ...
  },
  {
    slug: "pdf-to-excel",
    name: "PDF to Excel",
    description: "Pull tables from PDFs into Excel.",
    icon: Sheet,
    category: "convert",
  },
  {
  ...
  },
  {
    slug: "reorder-pages",
    name: "Reorder Pages",
    description: "Drag-and-drop page sorting.",
    icon: ArrowUpDown,
    category: "organize",
  },
  {
    slug: "delete-pages",
    name: "Delete Pages",
    description: "Remove unwanted pages instantly.",
    icon: Trash2,
    category: "organize",
  },

  {
    slug: "crop-pdf",
    name: "Crop PDF",
    description: "Trim margins and unwanted areas.",
    icon: Crop,
    category: "edit",
  },
  {
    slug: "rotate-pdf",
    name: "Rotate PDF",
    description: "Fix orientation of any page.",
    icon: RotateCw,
    category: "edit",
  },
  {
    slug: "edit-pdf",
    name: "Edit PDF",
    description: "Modify text, images, and shapes.",
    icon: Pencil,
    category: "edit",
  },
  {
  ...
  },
  {
    ...
    description: "Number pages with custom styles.",
    icon: Hash,
    category: "edit",
  },
  {
    ...
    description: "Capture and digitize documents.",
    icon: Camera,
    category: "edit",
  },
  ...
  },
  {
    slug: "protect-pdf",
    name: "Protect PDF",
    description: "Add password and restrictions.",
    icon: Lock,
    category: "secure",
  },
  {
  ...
  },
  {
    slug: "ai-translate",
    name: "Translate PDF",
    description: "Translate while preserving layout.",
    icon: Languages,
    category: "ai",
    pro: true,
  },
